...
var years = {
    2012: {
        from: 9, to: 12,
        aroma: ['Moment privilégié', 'Dégustation de vins à la maison de la sorcière', 'Recharger pour le week-end', 'Un joyeux dîner de Noël']
    },
    2013: {
        from: 1, to: 16,
        aroma: ['Le Masque', 'Paix Sur Terre', 'Vin, Pain, Fromage et Fruits', 'Les Sirènes du Vin',
                 'Sally', 'Ohhh. C\'est Délicieux!', 'Allée de la Pause', 'Mondes Différents',
                 'Cuivre Toujours', 'Dégustation de Vins au Chateau de Dracula', 'Dracula', 'Le Monstre de Frankenstein', 'La Sorcière', 'Le Loup-Garou', 'Récolte Verte Dans la Vallée', 'Père Noël Contre Grinch']
    },
    2014: {
        from: 1, to: 16,
        aroma: ['Arômes Bordelais', 'Coucher de Soleil', 'Dionysos', 'La Crête', 'Jeunes Mariés', 'Filles d\'Été',
                'Rafraîchissements en Terrasse', 'Arômes de Riesling', 'Bouffon de la Bière',
                'Dégustation de vins au Laboratoire à Monstre de Frankenstein', 'Citrouille d\'Halloween', 'Squelette', 'Zombie', 'Momie', 'Automne', 'Natura Dominae']
    },
    2015: {
        from: 1, to: 16,
        aroma: ['Après-midi Neigeux','Tomber Amoureux','Le Printemps','Arômes de Provence','L\'amour Ivre','Des Vases à fleurs et des Fruits','En Pêchant',
                'Le Pique-Nique', 'Giovanni dans les Vignes', 'Dégustation de Vin Avec le Loup-Garou', 'Les Chiens gardiens des Enfers',
                'Le Chat Noir', 'L\'Araignée', 'La Chauve-souris', '','Parfaite']
    },
    2016: {
        from: 1, to: 12,
        aroma: ['O Canada', 'In Vino Veritas', 'Moment Personnel', 'Sen\'i 遷移 - Transition', 'Toi et Moi', 'Mosaïque Estivale', 'Boissons en Terrasse', 'À la vôtre!', 'Grillade et détente',
            'La lumière révèle l\'obscurité.','','L’esprit']
    },
	 2017: {
        from: 1,
        to: 12,
        aroma: ['De tous milieux', '', 'Vin', 'Floraison de l\'esprit', 'Épiphanie', 'Roi De Coeur','Canada 150','Vin Satellite','Vignes de vignoble','La vie du vin','Journée humide vin sec','']
    },
	2018: {
        from: 1,
        to: 12,
        aroma: ['Love','Modern Love','Primavera','The Big Squeeze','The Wine Fair','Christopher Stewart Has Gone Mad - will you save this innocent Grape?','','','Le nez sait!','Pura Passion','La coïncidence la plus douce','Une visite de Christopher Stewart']
    },
	2019: {
        from: 1,
        to: 6,
...
var MSG_PASSWORD_LENGTH = "Le mot de passe doit contenir au moins 6 caractères.";
