...
var years = {
    2012: {
        from: 9,
        to: 12,
        aroma: ['寶貴時光', '女巫家中品酒會', '滿載週末', '快樂聖誕晚餐']
    },
    2013: {
        from: 1,
        to: 16,
        aroma: ['面具', '和平', '葡萄酒,麵包,芝士和生果', '葡萄酒女妖', '休閒', '嗨,真是美味', '偷閒小巷',
                '不同世界', '銅製蒸餾器', '德古拉城堡品酒會', '吸血鬼', '科學怪人的怪獸', '女巫', '狼人', '山谷中綠色採收', '聖誕老人VS聖誕怪傑']
    },
    2014: {
        from: 1,
        to: 16,
        aroma: ['唇齒留香波爾多', '日落', '酒神', '古典徽章', '新婚燕爾', '夏日女孩', '露臺上的茶點', '清香四溢雷司令', '啤酒小丑',
            '科學怪物實驗室品酒會', '萬聖節南瓜', '骷髏', '殭屍', '木乃伊', '秋', '大自然女神']
    },
    2015: {
        from: 1,
        to: 16,
        aroma: ['飄雪午後', '沈醉', '春', '芳香普羅旺斯', '醉愛', '花瓶与水果', '垂釣', '野餐', '喬萬尼在葡萄園', '與狼人共飲', '地獄獵犬', '黑貓', '蜘蛛', '蝙蝠', '', '滿載而歸']
    },
    2016: {
        from: 1,
        to: 12,
        aroma: ['啊, 加拿大', '酒後吐真言', '自己的時間', '遷移', '你和我', '夏日馬賽克', '露臺小酌', '乾杯！', '燒烤與消閒', '光明揭示黑暗','','精靈']
    },
	 2017: {
        from: 1,
        to: 12,
        aroma: ['我們', '', '紅酒', '花開', '靈光乍現 ', '王者紅心', '加拿大 150', '葡萄酒衛星', '葡萄園之歌','品味人生','長街細雨幹紅夜','']
    },
	2018: {
        from: 1,
        to: 12,
        aroma: ['愛','現代愛情','春','迸發','紅酒博覽會','詩德發狂了-拯救葡萄','','','聞香識紅酒','普拉的激情','浪漫偶遇','詩德的拜訪']
    },
	2019: {
        from: 1,
        to: 6,
        aroma: ['新年','繁花似錦','快樂','詩德之光','节日','藝術療愈','','','','','','']
    }
};

//var TEXT_PORTFOLIO_MONTH = "2018年8月版本已推出";
...
var MSG_PASSWORD_LENGTH = "請輸入正確密碼，密碼必須由最少六個字母符號組成。";
