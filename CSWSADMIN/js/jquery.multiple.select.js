...
(function ($) {
    ...
    function MultipleSelect($el, options) {
        ...
        this.$choice = $('<button type="button" class="ms-choice ms_choice_career"><span class="placeholder placeholder_career">' +
            options.placeholder + '</span><div></div></button>');
        this.$drop = $('<div class="ms-drop ms-drop_career ' + options.position + '"></div>');
        ...
        init: function () {
            ...
            if (this.options.selectAll && !this.options.single) {
                ul.append(
                    ...
                    '<label class="career_label_selectAll">' +
                    '<input class="checkbox_career" type="checkbox" ' + this.selectAllName + ' /> ' +
        ...
        optionToHtml: function (i, elm, group, groupDisabled) {
            ...
            if ($elm.is('option')) {
                ...
                if ((this.options.blockSeparator > "") && (this.options.blockSeparator == $elm.val())) {
                    ...
                    var li = $(
                        '<li' + clss + style + '>' +
                        '<label class="career_dropdown_display"' + (disabled ? ' class="disabled"' : '') + '>' +
                        '<input class="checkbox_career" type="' + type + '" ' + this.selectItemName +
                ...
                group.append(
                    ...
                    (this.options.hideOptgroupCheckboxes ? '' : '<input class="checkbox_career" type="checkbox" ' + this.selectGroupName +
                        (disabled ? ' disabled="disabled"' : '') + ' /> ') +
                    label +
                    '</label>' +
                    '</li>');
